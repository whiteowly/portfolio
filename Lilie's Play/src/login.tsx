            ...
            <p key={p.id} className="project-card" rel="noreferrer">
              <div className="card-inner">
                ...
                <div className="card-body">
                  ...
                  {p.status && <p className={`status ${String(p.status).toLowerCase().replace(/\s+/g, '-')}`}>{p.status}</p>}
                  </div>
                  ...
                  <div className="project-meta">
                    <div className="resume-wrap">
                      ...
                      <a href={p.link} target="_blank" rel="noreferrer" className="download-btn">Code</a>
                    </div>
